file:///C:/Users/hamano/Documents/college/zemi/github/bc-java-main/prov/src/test/java/org/bouncycastle/jce/provider/test/ZucTest8.java
### java.util.NoSuchElementException: next on empty iterator

occurred in the presentation compiler.

action parameters:
uri: file:///C:/Users/hamano/Documents/college/zemi/github/bc-java-main/prov/src/test/java/org/bouncycastle/jce/provider/test/ZucTest8.java
text:
```scala
    ...
    extends SimpleTest
{
    ...
    throws Exception
    {
        ...
        final byte[] myExpected = Arrays.copyOf(Hex.decode(pTestCase.theExpected), 2000);
        ...
        throws Exception
    {
        ...
        System.out.println("Zuc-128の処理時間: " + executionTimeZuc128 + " ミリ秒");
        ...
        long startTimeZuc256 = System.currentTimeMillis();
        testCipher(zuc256, ZUC256_TEST1);
        long endTimeZuc256 = System.currentTimeMillis();
        long executionTimeZuc256 = endTimeZuc256 - startTimeZuc256;
        System.out.println("Zuc-256の処理時間: " + executionTimeZuc256 + " ミリ秒");
        ...
        long startTimeMac128 = System.currentTimeMillis();
        ...
        long endTimeMac128 = System.currentTimeMillis();
        long executionTimeMac128 = endTimeMac128 - startTimeMac128;
        System.out.println("Zuc-128 Macの処理時間: " + executionTimeMac128 + " ミリ秒");
        
        long startTimeMac256 = System.currentTimeMillis();
        ...
        long endTimeMac256 = System.currentTimeMillis();
        long executionTimeMac256 = endTimeMac256 - startTimeMac256;
        System.out.println("Zuc-256 Macの処理時間: " + executionTimeMac256 + " ミリ秒");
